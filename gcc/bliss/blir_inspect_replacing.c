...
/* Implements the replacing functionality of the BLISS inspect clause,
 supporting ANSI 85 syntax.  It replaces identifier1, replacing_count
 occurrences defined in blir_inspect_replacing_struct.  */
