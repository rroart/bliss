 ...
 *                          Josling  25/Nov/2000  Split from display  *
 *                          routines                                  *
 *                                                                    *
 *********************************************************************  */

#ifndef __BLIR_STOP__
#define __BLIR_STOP__

#include <stdio.h>

#include "blir_temp_config.h"

void blir_stop_literal (const char *literal,  /* Text of message.  */
                             size_t length);  /* Length of message.  */

void blir_stop_run (int return_code);  /* Return code.  */

void blir_error_drop_off_end (void);
